...
/**
 * Gets a usernames/{uid} document reference
 * @param {string} uid
 */
export function getUsernamesDoc(uid) {
  return doc(db, "usernames", uid);
}
...
/**
 * Gets the last `n` posts from user given `uid`
 * @param  {string} uid
 * @param  {number} n
 */
export async function getNReviewsOf(uid, n) {
  ...
  return snap.empty ? null : snap.docs.map(postToJSON);
}
